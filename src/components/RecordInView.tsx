  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-end">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">Rekod Masuk Asrama</h1>
          <p className="text-sm text-slate-500 mt-1">Sahkan pelajar masuk / pulang ke kawasan asrama.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-4xl">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
          ...
          {method === 'qr' ? (
            <div className="flex flex-col items-center justify-center p-8 border-2 border-dashed border-slate-300 rounded-xl bg-slate-50">
              ...
              <p className="text-sm text-slate-500 text-center">Halakan kamera pada Kod QR pas pelajar untuk mengimbas log masuk.</p>
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              <div>
                ...
                <div className="flex space-x-2">
                  <input type="text" placeholder="Cth: P001" className="flex-1 text-sm border-slate-300 rounded-lg shadow-sm focus:border-teal-500 focus:ring-teal-500 p-2.5 border" />
                  <button className="bg-teal-600 hover:bg-teal-700 text-white px-4 py-2.5 rounded-lg transition-colors font-medium">Cari</button>
                </div>
              </div>
            </form>
          )}
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
          <div className="p-4 bg-slate-50 border-b border-slate-200">
            <h2 className="font-semibold text-slate-800">Semakan Kepulangan</h2>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <div className="inline-flex items-center mt-2 px-2.5 py-0.5 rounded-full text-xs font-medium bg-amber-100 text-amber-700 border border-amber-200">
                    <Icons.Clock className="w-3 h-3 mr-1" /> Berada Di Luar
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-50 rounded-lg p-4 border border-slate-200 text-sm">
                <div className="grid grid-cols-2 gap-y-2">
                  <div className="text-slate-500">Waktu Keluar:</div>
                  <div className="font-medium text-slate-800">10 Nov, 15:00</div>
                  <div className="text-slate-500">Had Pulang:</div>
                  <div className="font-medium text-slate-800">12 Nov, 17:00</div>
                  <div className="text-slate-500">Status Kepulangan:</div>
                  <div className="font-medium text-emerald-600">Menepati Masa (Awal)</div>
                </div>
              </div>
            </div>

            <button className="w-full mt-6 bg-teal-600 hover:bg-teal-700 text-white py-3 rounded-lg font-bold text-lg shadow-sm transition-colors flex items-center justify-center">
              <Icons.LogIn className="w-5 h-5 mr-2" /> SAHKAN MASUK
            </button>
          </div>
        </div>
      </div>
